...
from credit_card_validation import check_divisibility_by_ten
...
class TestCheckDivisibilityByTenFunction(unittest.TestCase):
	def test_that_the_check_divisibility_by_ten_function_accepts_1_argument(self):
		function_signature = inspect.signature(check_divisibility_by_ten)
		dic_parameter = function_signature.parameters
		self.assertEqual(len(dic_parameter), 1)
	def test_that_the_check_divisibility_by_ten_function_raises_validation_when_argument_is_a_float(self):
		self.assertRaises(TypeError, check_divisibility_by_ten, 32.8)
	def test_that_the_check_divisibility_by_ten_function_raises_validation_when_argument_is_a_numeric_string(self):
		self.assertRaises(TypeError, check_divisibility_by_ten, "32")
	def test_that_the_check_divisibility_by_ten_function_raises_validation_when_argument_is_a_non_numeric_string(self):
		self.assertRaises(TypeError, check_divisibility_by_ten, "mummy")
	def test_that_the_check_divisibility_by_ten_function_raises_validation_when_argument_is_empty(self):
		self.assertRaises(ValueError, check_divisibility_by_ten, 0)
	def test_that_the_check_divisibility_by_ten_function_returns_correct_result(self):
		result = check_divisibility_by_ten(70)
		self.assertEqual(result, 'Valid')
	def test_that_the_check_divisibility_by_ten_function_returns_correct_result(self):
		result = check_divisibility_by_ten(76)
